...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Patisserie::class, mappedBy="user", orphanRemoval=true)
     */
    private $patisseries;
    ...
    public function removePatisseries(Patisserie $patisseries): self
    {
        if ($this->patisseries->removeElement($patisseries)) {
            ...
            if ($patisseries->getUser() === $this) {
                $patisseries->setUser(null);
            }
        }
